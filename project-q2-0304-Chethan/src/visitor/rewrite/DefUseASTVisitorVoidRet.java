 ...
 * @since JavaSE-1.8
 */
public class DefUseASTVisitorVoidRet extends ASTVisitor {
   private Map<IVariableBinding, DefUseModel> defUseMap = new HashMap<IVariableBinding, DefUseModel>();
   private int fAccessesToSystemFields;
   private CompilationUnit compilationUnit;
 

   public DefUseASTVisitorVoidRet(CompilationUnit compilationUnit) {
      this.compilationUnit = compilationUnit;
   ...
   @Override
	public boolean visit(MethodDeclaration node) {
	   ...
	   //System.out.println("I am void before check");
