 ...
 * @since JavaSE-1.8
 */
public class DefUsePublicMethodHandler {
   final String viewId = "project-q2-0304-chethan.partdescriptor.simpleviewq2chethan";
   public final static String POPUPMENU = "project-q2-0304-chethan.popupmenu.mypopup";
