...
import analysis.ProjectAnalyzerDefUseSearchCaller;
...
public class SimpleViewer {
   public final static String VIEWID = "project-q2-bonus-0304-chethan.partdescriptor.simpleviewq2bonuschethan";
   ...
   private void createSearchTextV1(Composite parent) {
      ...
      searchText.addListener(SWT.KeyDown, new Listener() {
         public void handleEvent(Event e) {
            if (e.keyCode == SWT.CR) {
               reset();
               ProjectAnalyzerDefUseSearchCaller analyzer = new ProjectAnalyzerDefUseSearchCaller(searchText.getText());
               try {
             ...
             //  List<Map<IVariableBinding, DefUseModel>> analysisDataList = analyzer.getAnalysisDataList();
               ...
               //DefUseASTVisitor defuse= new DefUseASTVisitor();
            }
         }
      });
   }
