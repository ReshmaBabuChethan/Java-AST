...
import view.provider.LabelProviderStartPosition;

public class Viewer {
   public static final String ID = "project-ex-0218-tree-chethan.partdescriptor.simpleasttreechethan";
   ...
   // adding for third
      ...
      col.setLabelProvider(new DelegatingStyledCellLabelProvider(new LabelProviderStartPosition()));
   }
   ...
   private void addListener() {
      ...
      viewer.addDoubleClickListener(new IDoubleClickListener() {
         ...
         public void doubleClick(DoubleClickEvent event) {
            ...
            Object parent = tcp.getParent(selectedNode);
            System.out.println("[DBG] My Parent Node: " + parent);
         }
      });
