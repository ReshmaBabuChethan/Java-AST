 ...
 * package view;
 * 
 * import javax.inject.Inject; import javax.annotation.PostConstruct; import
 * org.eclipse.swt.widgets.Composite;
 * 
 * public class MyTableViewer {
 * 
 * @Inject public MyTableViewer() {
 * 
 * }
 * 
...
public class MyTableViewer {
   //public final static String ID = "simpletableast3insertdeleteexample.partdescriptor.simplesimpleview";
	public final static String ID = "project-ex-0204-type-delete-ast-chethan.partdescriptor.simpletableview-deletemethodast-0204chethan";
   //public final static String POPUPMENU = "simpletableast3insertdeleteexample.popupmenu.mypopupmenu";
	public final static String POPUPMENU = "project-ex-0204-type-delete-ast-chethan.popupmenu.mypopupmenu";
