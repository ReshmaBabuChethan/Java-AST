...
import handler.AnalyzeMethodCallerHandler;
...
public class SimpleViewer {
   public final static String VIEWID = "project-midterm-0323-defuse-chethan.partdescriptor.simpleviewmidtermdefusechethan";
   ...
   private void display(IMethod callee, IMethod[] callers, List<Map<IVariableBinding, DefUseModel>> analysisDataList) {
      for (IMethod iCaller : callers) {
         ...
         AnalyzeMethodCallerHandler.displayDefUsedView(iCaller.getElementName(),this.styledText, analysisDataList);
