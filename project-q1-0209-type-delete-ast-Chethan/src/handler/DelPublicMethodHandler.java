...
import analysis.DelPublicMethodAnalyzer;
 ...
 * @since J2SE-1.8
 */
public class DelPublicMethodHandler {
   ...
   public void execute() {
      ...
      if (findPartObj instanceof MyTableViewer) {
         ...
         if (selectionService.getSelection() instanceof ProgramElement) {
            ...
            //Check whether its public and ok to delete
         DelPublicMethodAnalyzer delPublicAnalyzer = new DelPublicMethodAnalyzer(p);
