...
public class MyTableViewer {
	public final static String ID = "projectex0926typedeleteastredwine.partdescriptor.simpletableview";
	public final static String POPUPMENU = "projectex0926typedeleteastredwine.popupmenu.mypopupmenu";
