...
public class MyTableViewer {
   public final static String ID ="project-ex-0202-table-chethan.partdescriptor.simpletableaddingdeletingchethan";
   public final static String POPUPMENU = "project-ex-0202-table-chethan.popupmenu.mypopupmenu";
   ...
   private void createColumns(final Composite parent, final TableViewer viewer) {
      ...
      col.setLabelProvider(new PhoneLabelProvider());
      col.setEditingSupport(new PhoneEditingSupport(viewer));

      col = createTableViewerColumn(titles[3], bounds[3], 3);
      col.setLabelProvider(new EmailLabelProvider());
