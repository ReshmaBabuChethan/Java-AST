...
public class MyTableViewer {
   ...
   public final static String ID = "project-midterm-0323-delete-ast-chethan.partdescriptor.simpletableviewdeleteastschethan";
   //public final static String POPUPMENU = "simpletableast3insertdeleteexample.popupmenu.mypopupmenu";
   public final static String POPUPMENU = "project-midterm-0323-delete-ast-chethan.popupmenu.mypopupmenu";
