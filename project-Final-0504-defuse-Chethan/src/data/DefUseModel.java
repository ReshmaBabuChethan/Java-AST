...
public class DefUseModel {
   ...
   public DefUseModel(VariableDeclarationStatement node, VariableDeclarationFragment varFrag, String ctrlBody) {
	   this.vds = vds;
	      this.vdf = vdf;
...
public VariableDeclarationStatement getVarDeclStmt() {
   ...
   public String getctrlBody() {
	      return this.ctrlBody;
	   }

	   public void setctrlBody(String ctrlBody) {
	      this.ctrlBody = ctrlBody;
	   }
