...
public class MyTableViewer {
   ...
   public final static String ID = "project-final-0504-delete-ast-chethan.partdescriptor.simpletableviewdeleteastschethan";
   //public final static String POPUPMENU = "simpletableast3insertdeleteexample.popupmenu.mypopupmenu";
   public final static String POPUPMENU = "project-final-0504-delete-ast-chethan.popupmenu.popupmenu";
