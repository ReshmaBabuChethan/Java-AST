   ...
   private void addListener() {
      ...
      viewer.addDoubleClickListener(new IDoubleClickListener() {
         ...
         public void doubleClick(DoubleClickEvent event) {
            ...
            Integer count=ModelProvider.INSTANCE.testGetNumChildNodes((Person)selectedNode);
            //MessageDialog.openInformation(null, "# of Child Nodes",ModelProvider.INSTANCE.testGetNumChildNodes((Person)selectedNode).toString());
            MessageDialog.openInformation(null, "# of Child Nodes",count.toString());
               }
      });
